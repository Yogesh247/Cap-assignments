	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 List<Fruit> Fruit_list = new LinkedList<>();
	        ...
	        Trader_list.add(new Trader("Yogesh", "pune"));
	        ...
	        List<Transaction> Trans_list = Arrays.asList(
	                new Transaction(new Trader("Yogesh", "Delhi"), 2012, 4500),
	                new Transaction(new Trader("Sanjay", "Delhi"), 2011, 4800),
	                new Transaction(new Trader("Shivanee", "Indore"), 2011, 4400));
